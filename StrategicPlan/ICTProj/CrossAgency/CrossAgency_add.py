...
def CrossAgency_add(driver):
    ...
    CrossAgency = Select(driver.find_element(By.XPATH, "//select[@id='ict_project']"))
    CrossAgency.select_by_index(2)
    ...
    for form_data in form_data_list:
        try:
            ...
            lead_field = driver.find_element(By.XPATH, "//input[@placeholder='Select Lead Agency']")
            lead_field.click()
            time.sleep(2)
            ...
            implementing_field = driver.find_element(By.XPATH, "//input[@placeholder='Select Implementing Agency']")
            implementing_field.click()
            time.sleep(2)
            options = WebDriverWait(driver, 10).until(
                EC.visibility_of_all_elements_located((By.CLASS_NAME, "vs__dropdown-menu"))
            )
            ...
            expected_text = "Cross-Agency ICT Project added successfully."
