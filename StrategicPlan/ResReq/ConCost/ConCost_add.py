...
def ConCost_add(driver):
    ...
    resource = WebDriverWait(driver, 30).until(
        EC.element_to_be_clickable((By.XPATH, "/html[1]/body[1]/div[1]/div[1]/div[1]/div[2]/div[2]/main[1]/div[1]/div[2]/div[1]/ul[1]/li[4]/p[1]"))
    )
    resource.click()

    concost = Select(driver.find_element(By.XPATH, "/html/body/div[1]/div/div/div[2]/div[2]/main/div/div[3]/div/form/div[1]/div[1]/select"))
    concost.select_by_index(1)
        ...
        try:
            ...
            try:
                assert WebDriverWait(driver, 10).until(
                    EC.visibility_of_element_located((By.XPATH, "//span[normalize-space()='Classification']"))
                ), "Classification field name not found"
                print("Classification field name is visible")

                assert WebDriverWait(driver, 10).until(
                    EC.visibility_of_element_located((By.XPATH, "//span[normalize-space()='Name of Ongoing ICT Project']"))
                ), "Name of Ongoing ICT Project field name not found"
                print("Name of Ongoing ICT Project field name is visible")
            ...
            classification_field = driver.find_element(By.XPATH, "/html[1]/body[1]/div[3]/div[2]/div[1]/div[2]/form[1]/div[2]/div[1]/div[1]/div[1]/input[1]")
            classification_field.send_keys("Ongoing ICT Project")
            time.sleep(2)
            ...
            print("0")
            # time.sleep(100)
            name_field = driver.find_element(By.XPATH, "/html/body/div[3]/div[2]/div/div[2]/form/div[3]/div/div/div[1]/input")
            name_field.click()
            options = WebDriverWait(driver, 10).until(
                EC.visibility_of_all_elements_located((By.CLASS_NAME, "vs__dropdown-menu"))
            )
            ...
            item_field = driver.find_element(By.XPATH, "/html[1]/body[1]/div[3]/div[2]/div[1]/div[2]/form[1]/div[4]/div[1]/div[1]/div[1]/input[1]")
            item_field.click()
            time.sleep(1)
            options = WebDriverWait(driver, 10).until(
                EC.visibility_of_all_elements_located((By.CLASS_NAME, "vs__dropdown-menu"))
            ...
            desired_option.click()
            print("1")
            class_field = driver.find_element(By.XPATH, "/html[1]/body[1]/div[3]/div[2]/div[1]/div[2]/form[1]/div[5]/div[1]/div[1]/div[1]/input[1]")
            class_field.click()
            time.sleep(1)
            options = WebDriverWait(driver, 10).until(
                EC.visibility_of_all_elements_located((By.CLASS_NAME, "vs__dropdown-menu"))
            ...
            desired_option.click()
            print("2")
            office_field = driver.find_element(By.XPATH, "/html[1]/body[1]/div[3]/div[2]/div[1]/div[2]/form[1]/div[6]/div[1]/div[1]")
            office_field.click()
            time.sleep(1)
            options = WebDriverWait(driver, 10).until(
                EC.visibility_of_all_elements_located((By.CLASS_NAME, "vs__dropdown-menu"))
            ...
            desired_option.click()
            print("3")
            number_field = driver.find_element(By.XPATH, "/html[1]/body[1]/div[3]/div[2]/div[1]/div[2]/form[1]/div[7]/div[3]/div[1]/div[2]/input[1]")
            number_field.clear()
            number_field.send_keys(form_data["number"])

            # Click the save button and handle confirmation
            save_button = WebDriverWait(driver, 10).until(
                EC.visibility_of_element_located((By.XPATH, "/html[1]/body[1]/div[3]/div[2]/div[1]/div[2]/form[1]/div[9]/div[2]/div[1]/div[1]/button[2]"))
            )
