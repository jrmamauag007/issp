...
def OfficeProd_add(driver):
    ...
    for form_data in form_data_list:
        try:
            ...
            item_field = driver.find_element(By.XPATH, "/html/body/div[2]/div[2]/div/div[2]/form/div[2]/div/div/div[1]/input")
            item_field.click()
            time.sleep(3)
            ...
            class_field = driver.find_element(By.XPATH, "/html/body/div[2]/div[2]/div/div[2]/form/div[3]/div/div/div[1]/input")
            class_field.click()
            time.sleep(1)
            options = WebDriverWait(driver, 10).until(
                EC.visibility_of_all_elements_located((By.CLASS_NAME, "vs__dropdown-menu"))
            ...
            office_field = driver.find_element(By.XPATH, "/html/body/div[2]/div[2]/div/div[2]/form/div[4]/div/div/div[1]/input")
            office_field.click()
            time.sleep(1)
            options = WebDriverWait(driver, 10).until(
                EC.visibility_of_all_elements_located((By.CLASS_NAME, "vs__dropdown-menu"))
            ...
            number_field = driver.find_element(By.XPATH, "/html/body/div[2]/div[2]/div/div[2]/form/div[5]/div[3]/div/div[2]/input")
            number_field.clear()
            number_field.send_keys(form_data["number"])

            # Click the save button and handle confirmation
            save_button = WebDriverWait(driver, 10).until(
                EC.visibility_of_element_located((By.XPATH, "/html/body/div[2]/div[2]/div/div[2]/form/div[7]/div[2]/div/div[1]/button[2]"))
            )
