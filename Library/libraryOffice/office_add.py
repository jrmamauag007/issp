...
def office_add(driver):
    ...
    office = WebDriverWait(driver, 30).until(
        EC.element_to_be_clickable((By.XPATH, "/html/body/div[1]/div/div/div[2]/div[2]/main/div/div[2]/div/ul/li[2]/p"))
    )
    office.click()
    ...
    form_data_list = [
        {
            "office_name": "Planning and Evaluation Service2",
            "alias": "PES",
            "first_name": "John",
            "middle_initial": "D",
            "surname": "Doe",
